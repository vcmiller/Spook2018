...
namespace SBR {
    ...
    public class SplineMeshProfile : ScriptableObject {
        ...
        public class MeshInfo {
            ...
            public float meshLength => render != null ? render.bounds.size.z : 0;
            public float gapLength => gapBefore + gapAfter;
            public float totalLength => meshLength + gapLength;
        }
        ...
        public int GetSubmeshCount() {
            if (keepSeparateMaterials) {
                int submeshCount = 0;
                if (submeshStartIndices?.Length != meshes.Length) {
